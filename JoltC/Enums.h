...
ENSURE_ENUM_EQ(JPC_CHARACTER_GROUND_STATE_ON_GROUND, JPH::CharacterBase::EGroundState::OnGround)
ENSURE_ENUM_EQ(JPC_CHARACTER_GROUND_STATE_ON_STEEP_GROUND, JPH::CharacterBase::EGroundState::OnSteepGround)
ENSURE_ENUM_EQ(JPC_CHARACTER_GROUND_STATE_NOT_SUPPORTED, JPH::CharacterBase::EGroundState::NotSupported)
ENSURE_ENUM_EQ(JPC_CHARACTER_GROUND_STATE_IN_AIR, JPH::CharacterBase::EGroundState::InAir)
...
typedef enum JPC_MeshShapeSettings_BuildQuality: uint32_t {
	JPC_MESH_SHAPE_SETTINGS_BUILD_QUALITY_FAVOR_RUNTIME_PERFORMANCE = 0,
	JPC_MESH_SHAPE_SETTINGS_BUILD_QUALITY_FAVOR_BUILD_SPEED = 1,
} JPC_MeshShapeSettings_BuildQuality;

ENSURE_ENUM_EQ(JPC_MESH_SHAPE_SETTINGS_BUILD_QUALITY_FAVOR_RUNTIME_PERFORMANCE, JPH::MeshShapeSettings::EBuildQuality::FavorRuntimePerformance)
ENSURE_ENUM_EQ(JPC_MESH_SHAPE_SETTINGS_BUILD_QUALITY_FAVOR_BUILD_SPEED, JPH::MeshShapeSettings::EBuildQuality::FavorBuildSpeed)